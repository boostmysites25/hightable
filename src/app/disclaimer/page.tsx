    ...
    return (
        <section className="bg-[#050A10] min-h-screen text-[#EFD9F7] py-20 px-4 flex items-center justify-center">
            <div className="max-w-2xl text-center space-y-6">
                <h1 className="text-3xl font-bold text-[#C78D17] uppercase tracking-widest mb-8">Disclaimer</h1>
                ...
                <div className="pt-12">
                    <a href="/" className="text-[#C78D17] hover:text-[#EFD9F7] uppercase text-sm tracking-widest transition-colors">Return to Home</a>
                </div>
            </div>
        </section>
    );
