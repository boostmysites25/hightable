        ...
        <section ref={sectionRef} className="py-24 md:py-32 bg-[#1a162b] relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 max-w-4xl text-center">
                ...
                <div className="world-text flex items-center justify-center gap-4 mb-12 opacity-50">
                    <div className="w-3 h-3 rounded-full border border-[#AD986E]" />
                    <div className="w-24 h-px bg-[#AD986E]" />
                </div>

                <div className="space-y-8 text-gray-400 font-light leading-relaxed text-lg md:text-xl">
